...
class BackgroundCountdown extends BaseCountdown {
    ...
    public void initStyleAttr(Context context, TypedArray ta) {
        ...
        mTimeBgColor = ta.getColor(R.styleable.FuckView_timeBgColor, 0xFF444444);
        mTimeBgRadius = ta.getDimension(R.styleable.FuckView_timeBgRadius, 0);
        isShowTimeBgDivisionLine = ta.getBoolean(R.styleable.FuckView_isShowTimeBgDivisionLine, true);
        mTimeBgDivisionLineColor = ta.getColor(R.styleable.FuckView_timeBgDivisionLineColor, Color.parseColor("#30FFFFFF"));
        mTimeBgDivisionLineSize = ta.getDimension(R.styleable.FuckView_timeBgDivisionLineSize, Utils.dp2px(context, DEFAULT_TIME_BG_DIVISION_LINE_SIZE));
        mTimeBgSize = ta.getDimension(R.styleable.FuckView_timeBgSize, 0);
        mDefSetTimeBgSize = mTimeBgSize;
        mTimeBgBorderSize = ta.getDimension(R.styleable.FuckView_timeBgBorderSize, Utils.dp2px(context, DEFAULT_TIME_BG_BORDER_SIZE));
        mTimeBgBorderRadius = ta.getDimension(R.styleable.FuckView_timeBgBorderRadius, 0);
        mTimeBgBorderColor = ta.getColor(R.styleable.FuckView_timeBgBorderColor, 0xFF000000);
        isShowTimeBgBorder = ta.getBoolean(R.styleable.FuckView_isShowTimeBgBorder, false);

        isDrawBg = ta.hasValue(R.styleable.FuckView_timeBgColor) || !isShowTimeBgBorder;
    }
