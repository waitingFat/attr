...
class BaseCountdown {
    ...
    public void initStyleAttr(Context context, TypedArray ta) {
        mContext = context;
        isTimeTextBold = ta.getBoolean(R.styleable.FuckView_isTimeTextBold, false);
        mTimeTextSize = ta.getDimension(R.styleable.FuckView_timeTextSize, Utils.sp2px(mContext, 12));
        mTimeTextColor = ta.getColor(R.styleable.FuckView_timeTextColor, 0xFF000000);
        isShowDay = ta.getBoolean(R.styleable.FuckView_isShowDay, false);
        isShowHour = ta.getBoolean(R.styleable.FuckView_isShowHour, false);
        isShowMinute = ta.getBoolean(R.styleable.FuckView_isShowMinute, true);
        isShowSecond = ta.getBoolean(R.styleable.FuckView_isShowSecond, true);
        isShowMillisecond = ta.getBoolean(R.styleable.FuckView_isShowMillisecond, false);
        if (ta.getBoolean(R.styleable.FuckView_isHideBg, true)) {
            isConvertDaysToHours = ta.getBoolean(R.styleable.FuckView_isConvertDaysToHours, false);
        }
        isSuffixTextBold = ta.getBoolean(R.styleable.FuckView_isSuffixTextBold, false);
        mSuffixTextSize = ta.getDimension(R.styleable.FuckView_suffixTextSize, Utils.sp2px(mContext, 12));
        mSuffixTextColor = ta.getColor(R.styleable.FuckView_suffixTextColor, 0xFF000000);
        mSuffix = ta.getString(R.styleable.FuckView_suffix);
        mSuffixDay = ta.getString(R.styleable.FuckView_suffixDay);
        mSuffixHour = ta.getString(R.styleable.FuckView_suffixHour);
        mSuffixMinute = ta.getString(R.styleable.FuckView_suffixMinute);
        mSuffixSecond = ta.getString(R.styleable.FuckView_suffixSecond);
        mSuffixMillisecond = ta.getString(R.styleable.FuckView_suffixMillisecond);
        mSuffixGravity = ta.getInt(R.styleable.FuckView_suffixGravity, 1);
        mSuffixLRMargin = ta.getDimension(R.styleable.FuckView_suffixLRMargin, -1);
        mSuffixDayLeftMargin = ta.getDimension(R.styleable.FuckView_suffixDayLeftMargin, -1);
        mSuffixDayRightMargin = ta.getDimension(R.styleable.FuckView_suffixDayRightMargin, -1);
        mSuffixHourLeftMargin = ta.getDimension(R.styleable.FuckView_suffixHourLeftMargin, -1);
        mSuffixHourRightMargin = ta.getDimension(R.styleable.FuckView_suffixHourRightMargin, -1);
        mSuffixMinuteLeftMargin = ta.getDimension(R.styleable.FuckView_suffixMinuteLeftMargin, -1);
        mSuffixMinuteRightMargin = ta.getDimension(R.styleable.FuckView_suffixMinuteRightMargin, -1);
        mSuffixSecondLeftMargin = ta.getDimension(R.styleable.FuckView_suffixSecondLeftMargin, -1);
        mSuffixSecondRightMargin = ta.getDimension(R.styleable.FuckView_suffixSecondRightMargin, -1);
        mSuffixMillisecondLeftMargin = ta.getDimension(R.styleable.FuckView_suffixMillisecondLeftMargin, -1);

        mHasSetIsShowDay = ta.hasValue(R.styleable.FuckView_isShowDay);
        mHasSetIsShowHour = ta.hasValue(R.styleable.FuckView_isShowHour);
