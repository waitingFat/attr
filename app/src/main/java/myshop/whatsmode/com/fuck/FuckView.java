...
public class FuckView extends View {
    ...
    public FuckView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(R.styleable.FuckView);
        isHideTimeBackground = ta.getBoolean(R.styleable.FuckView_isHideBg, true);
        ...
        mCustomCountDownTimer = new CustomCountDownTimer(millisecond, countDownInterval) {
            ...
            public void onFinish() {
                ...
                if (null != mOnCountdownEndListener) {
                    mOnCountdownEndListener.onEnd(FuckView.this);
                }
            }
        };
    ...
    public interface OnCountdownEndListener {
        void onEnd(FuckView cv);
    }

    public interface OnCountdownIntervalListener {
        void onInterval(FuckView cv, long remainTime);
    }
